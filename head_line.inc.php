    ...
    <body>
        <div class="w3-top">
          <div class="w3-row w3-padding w3-black">
            ...
            <div class="w3-col s1">
              <a href="Top.php#home" class="w3-button w3-block w3-black scroll">HOME</a>
            </div>
            <div class="w3-col s1">
              <a href="Top.php#about" class="w3-button w3-block w3-black scroll">ABOUT</a>
            </div>
            <div class="w3-col s1">
              <a href="Top.php#menu" class="w3-button w3-block w3-black scroll">COMMENT</a>
            </div>
            <div class="w3-col s1">
              <a href="Top.php#where" class="w3-button w3-block w3-black scroll">WHERE</a>
            </div>
            <div class="w3-col s1">
              <a href="Top.php#contact" class="w3-button w3-block w3-black scroll">CONTACT</a>
            </div>
            <div class="w3-col s1">
