...
<html>
    ...
    <?php 
        ...
        if(isset($_POST['keyword'])) {
            ...
            $sql = "SELECT * FROM post WHERE post.Title LIKE '%".$keyword."%' ORDER BY Time DESC, Stars DESC";
    ...
    ?>
    <div id="header">
        <form action='searchKeyword.php' method='POST' style="margin-left: 2px;top:40%;">
